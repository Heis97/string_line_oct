 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define PLATE_SERIAL_SPEED 19200
...
/*#define FREQ_ISR 2000000.0f //hardware
#define TIME_ISR 20.0f //time for isr
#define TIME_ISR_INT 20 //time for isr
#define FREQ_MOTORS FREQ_ISR/TIME_ISR //hardware*/
//#define FREQ_MOTORS 100000.0f
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_BED_HYSTERESIS          20  // (°C) Temperature proximity considered "close enough" to the target
#endif
...
#define BED_OVERSHOOT    100   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 20, 20, 20,  20,20,20,20,20 }
 ...
 */
#define DEFAULT_ACCELERATION          100000    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  100000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   100000    // X, Y, Z acceleration for travel (non printing) moves
...
#define HOMING_FEEDRATE_MM_M { (1.8*60), (1.8*60), (1.8*60),(1.8*60),(1.8*60), (1.8*60), (1.8*60) }
