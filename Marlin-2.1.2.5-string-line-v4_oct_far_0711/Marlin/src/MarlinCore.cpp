...
void idle(const bool no_stepper_sleep/*=false*/) {
  ...
  string_manager.idle();
   ...
   //Serial.println(string_manager.get_temp(),BIN);
...
void setup() {
 ...
 SERIAL_ECHOLNPGM("thermalManager.init()");
   // Init stepper. This enables interrupts!
