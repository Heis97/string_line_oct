...
#ifndef Adafruit_MAX31865_sw_H
#define Adafruit_MAX31865_sw_H
...
class Adafruit_MAX31865_sw {
public:
  Adafruit_MAX31865_sw(int32_t spi_cs, int32_t spi_mosi, int32_t spi_miso,
             int32_t spi_clk);
...
private:
  int32_t sclkPin, misoPin, mosiPin, cselPin;
